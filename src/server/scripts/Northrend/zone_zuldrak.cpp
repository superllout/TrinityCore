                ...
                if (uiTimer <= diff)
                {
                    switch (uiPhase)
                    {
                        case 1:
                            ...
                            break;
                         case 2:
                            if (Creature* summon = ObjectAccessor::GetCreature(*me, _summonGUID))
...
public:
    ...
    struct npc_orinoko_tuskbreakerAI : public ScriptedAI
    {
        ...
        void EnterEvadeMode()
        {
            if (Creature* whisker = ObjectAccessor::GetCreature(*me, _whiskerGUID))
        ...
        void JustSummoned(Creature* summon) override
        {
            switch (summon->GetEntry())
            {
                ...
                case NPC_HUNGRY_PENGUIN:
                    if (Unit* affected = ObjectAccessor::GetUnit(*me, _affectedGUID))
                    {
                        if (affected->IsAlive())
