            ...
            if (sender == GOSSIP_SENDER_MAIN)
            {
                switch (actions)
                {
                    case GOSSIP_ACTION_INFO_DEF+1:
                    {
                        ...
                        Field * fields = NULL;
                        player->MonsterWhisper("|cffFFFF00Here are the Top 10 2v2 arena teams:|r", player);
                        do
                        {
                            fields = result->Fetch();
                    ...
                    case GOSSIP_ACTION_INFO_DEF+2:
                    {
                        ...
                        Field * fields = NULL;
                        player->MonsterWhisper("|cffFFFF00Here are the Top 10 3v3 arena teams:|r", player);
                        do
                        {
                            fields = result->Fetch();
                            string arena_name = fields[0].GetString();
                    ...
                    case GOSSIP_ACTION_INFO_DEF+3:
                    {
                        ...
                        Field * fields = NULL;
                        player->MonsterWhisper("|cffFFFF00Here are the Top 10 5v5 arena teams:|r", player);
                        do
                        {
                            fields = result->Fetch();
                            string arena_name = fields[0].GetString();
